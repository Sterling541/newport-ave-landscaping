  ...
  return (
    <ServicePageLayout
      ...
      galleryImages={[
        ...
        { src: "/manus-storage/DiscoveryWestPlazaHiResPhotos58_4ec582a1_b18aba65.webp", alt: "Newport Avenue crew in red uniforms working at Discovery West Plaza commercial landscape project in Bend Oregon" },
        { src: "/manus-storage/DiscoveryWestPlazaHiResPhotos57_fafc711f_5cc782eb.webp", alt: "Newport Avenue team maintaining the Discovery West Plaza commercial landscape in Bend Oregon" },
      ]}
