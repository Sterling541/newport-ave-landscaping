      ...
      <div style={{ paddingTop: '204px' }}>
        ...
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            ...
            <div className="overflow-x-auto mb-8"><table className="min-w-full bg-white border border-gray-300"><thead><tr><th className="py-2 px-4 border-b text-left">Fire Feature Type</th><th className="py-2 px-4 border-b text-left">Typical Cost</th><th className="py-2 px-4 border-b text-left">Notes</th></tr></thead><tbody><tr><td className="py-2 px-4 border-b">Boulder Wood Burning Pit</td><td className="py-2 px-4 border-b">$2,500–$3,500</td><td className="py-2 px-4 border-b">Natural boulders, wood burning</td></tr>
                  <tr><td className="py-2 px-4 border-b">Block Fire Pit Kit</td><td className="py-2 px-4 border-b">$5,500–$7,000</td><td className="py-2 px-4 border-b">Excludes gas line installation</td></tr>
                  <tr><td className="py-2 px-4 border-b">Fire Chimney (Natural Gas)</td><td className="py-2 px-4 border-b">$22,000+</td><td className="py-2 px-4 border-b">Excludes gas line installation</td></tr></tbody></table></div>
