...
export default function WaterFeatureCostBend() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'oklch(0.97 0.003 0)' }}>
      ...
      <FAQSchema faqs={[
        { question: `How much does a water feature cost in Bend, Oregon?`, answer: `Water feature costs in Bend vary by type. A rock bubbler costs $6,000–$8,000 installed. A small pondless waterfall, the most popular choice in Bend, typically costs $9,000–$11,000. A medium pondless waterfall runs $12,000–$18,000, and large statement waterfalls start at $24,000. Plunge ponds start at $90,000 for a fully custom build. Newport Avenue provides free on-site consultations and detailed proposals for all water feature projects in Central Oregon.` },
      ...
      <div style={{ paddingTop: '204px' }}>
        <div className="relative flex items-center justify-center" style={{ height:'380px',backgroundImage:'url(https://d2xsxph8kpxj0f.cloudfront.net/310519663503028182/g3pw3MRUapabcDUbhBEFxx/hero-water-features-wide-TWPMaWN7EEdHfyoL9z9Eki.webp',backgroundSize:'cover',backgroundPosition:'center 50%' }}>
        ...
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            ...
            <div className="overflow-x-auto mb-8"><table className="min-w-full bg-white border border-gray-300"><thead><tr><th className="py-2 px-4 border-b text-left">Feature Type</th><th className="py-2 px-4 border-b text-left">Typical Cost</th><th className="py-2 px-4 border-b text-left">Notes</th></tr></thead><tbody><tr><td className="py-2 px-4 border-b">Rock Bubbler</td><td className="py-2 px-4 border-b">$6,000–$8,000</td><td className="py-2 px-4 border-b">Simple, low maintenance</td></tr>
                  <tr><td className="py-2 px-4 border-b">Small Pondless Waterfall</td><td className="py-2 px-4 border-b">$9,000–$11,000</td><td className="py-2 px-4 border-b">Most popular choice in Bend</td></tr>
                  <tr><td className="py-2 px-4 border-b">Medium Pondless Waterfall</td><td className="py-2 px-4 border-b">$12,000–$18,000</td><td className="py-2 px-4 border-b">Multiple tiers, natural boulders</td></tr>
                  <tr><td className="py-2 px-4 border-b">Large Pondless Waterfall</td><td className="py-2 px-4 border-b">$24,000+</td><td className="py-2 px-4 border-b">Statement feature, custom design</td></tr>
                  <tr><td className="py-2 px-4 border-b">Plunge Ponds</td><td className="py-2 px-4 border-b">$90,000+</td><td className="py-2 px-4 border-b">Custom design, premium build</td></tr></tbody></table></div>
