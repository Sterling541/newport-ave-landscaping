...
const FireResistantPlantsCentralOregon: React.FC = () => {
  ...
  return (
    <div style={{ fontFamily: 'var(--font-label)', color: 'oklch(0.38 0.008 0)' }}>
      ...
      <section style={{ background: `linear-gradient(rgba(0,0,0,0.60), rgba(0,0,0,0.60)), url(/manus-storage/compressed_forest-home4_9324e5db_31f1b27d_a2d60b76.webp) center/cover no-repeat`, color: 'oklch(1 0 0)', padding: '4rem 0' }}>
