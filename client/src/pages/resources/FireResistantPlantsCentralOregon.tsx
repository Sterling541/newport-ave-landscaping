...
const FireResistantPlantsCentralOregon: React.FC = () => {
  ...
  return (
    <div style={{ fontFamily: 'var(--font-label)', color: 'oklch(0.38 0.008 0)' }}>
      ...
      <section style={{ background: `linear-gradient(rgba(0,0,0,0.60), rgba(0,0,0,0.60)), url(/manus-storage/forest-home4_9324e5db.jpg) center/cover no-repeat`, color: 'oklch(1 0 0)', padding: '4rem 0' }}>
