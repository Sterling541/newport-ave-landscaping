...
const s = {
  bg1: { background: `linear-gradient(rgba(0,0,0,0.60), rgba(0,0,0,0.60)), url(https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=1600&q=80) center/cover no-repeat`, padding: "5rem 0 3rem" },
