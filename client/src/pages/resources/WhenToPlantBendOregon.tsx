...
const s = {
  bg1: { background: `linear-gradient(rgba(0,0,0,0.60), rgba(0,0,0,0.60)), url(https://d2xsxph8kpxj0f.cloudfront.net/310519663503028182/g3pw3MRUapabcDUbhBEFxx/landscaping-native_fa3d1cfe.jpg) center/cover no-repeat`, padding: "5rem 0 3rem" },
