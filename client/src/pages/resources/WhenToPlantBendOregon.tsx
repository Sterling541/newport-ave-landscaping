...
const s = {
  bg1: { background: `linear-gradient(rgba(0,0,0,0.60), rgba(0,0,0,0.60)), url(/manus-storage/landscaping-native_fa3d1cfe.jpg) center/cover no-repeat`, padding: "5rem 0 3rem" },
