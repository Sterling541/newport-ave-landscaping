...
const DeschutesFireHardeningR327: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* ── Pricing Disclaimer ── */}
      <section style={{ background: `linear-gradient(rgba(0,0,0,0.60), rgba(0,0,0,0.60)), url(/manus-storage/forest-home4_9324e5db.jpg) center/cover no-repeat`, padding: "1.25rem 0" }}>
