...
const DeschutesFireHardeningR327: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* ── Pricing Disclaimer ── */}
      <section style={{ background: `linear-gradient(rgba(0,0,0,0.60), rgba(0,0,0,0.60)), url(https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1600&q=80) center/cover no-repeat`, padding: "1.25rem 0" }}>
