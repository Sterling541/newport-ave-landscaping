      ...
      <div style={{ paddingTop: '204px' }}>
        ...
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            ...
            <div className="overflow-x-auto mb-8"><table className="min-w-full bg-white border border-gray-300"><thead><tr><th className="py-2 px-4 border-b text-left">Service</th><th className="py-2 px-4 border-b text-left">Typical Cost</th><th className="py-2 px-4 border-b text-left">Frequency</th></tr></thead><tbody><tr><td className="py-2 px-4 border-b">Mowing & edging</td><td className="py-2 px-4 border-b">$45–$95/visit</td><td className="py-2 px-4 border-b">Weekly (Apr–Oct)</td></tr>
                  <tr><td className="py-2 px-4 border-b">Spring cleanup</td><td className="py-2 px-4 border-b">$200–$600</td><td className="py-2 px-4 border-b">Annual</td></tr>
                  <tr><td className="py-2 px-4 border-b">Fall cleanup</td><td className="py-2 px-4 border-b">$200–$600</td><td className="py-2 px-4 border-b">Annual</td></tr>
