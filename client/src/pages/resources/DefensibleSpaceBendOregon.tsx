  ...
  return (
    <>
      ...
      <main style={{ fontFamily: "system-ui, sans-serif", color: "oklch(0.38 0.008 0)", lineHeight: "1.6" }}>
        {/* Hero Section */}
        <section style={{ background: `linear-gradient(rgba(0,0,0,0.60), rgba(0,0,0,0.60)), url(/manus-storage/forest-home4_9324e5db_31f1b27d.webp) center/cover no-repeat`, color: "white", padding: "80px 20px", textAlign: "center" }}>
