        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside text-gray-700 leading-relaxed mb-4 pl-4">
              ...
              <li><strong className="text-[oklch(0.25_0.05_145)]">Ongoing Maintenance:</strong> Even water-wise landscapes benefit from proper care. Our <Link href="/services/maintenance" className="text-[oklch(0.25_0.05_145)] hover:underline">maintenance services</Link> ensure your landscape remains healthy and beautiful with minimal water use.</li>
            </ul>
            <p className="text-gray-700 leading-relaxed">
