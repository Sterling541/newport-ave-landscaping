    ...
    <div className="min-h-screen" style={{ backgroundColor: "oklch(0.97 0.003 0)" }}>
      ...
      <div style={{ paddingTop: "204px" }}>
        ...
        <div
          ...
          style={{
            height: "380px",
            backgroundImage: "url(https://d2xsxph8kpxj0f.cloudfront.net/310519663503028182/g3pw3MRUapabcDUbhBEFxx/hero-irrigation-install-wide-M3s4C9CoqDXhRhVMirSUhP.webp",
