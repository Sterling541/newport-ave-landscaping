      ...
      <div style={{ paddingTop: '328px' }}>
        ...
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            ...
            <div className="overflow-x-auto mb-8"><table className="min-w-full bg-white border border-gray-300"><thead><tr><th className="py-2 px-4 border-b text-left">Pergola Type</th><th className="py-2 px-4 border-b text-left">Typical Cost</th><th className="py-2 px-4 border-b text-left">Notes</th></tr></thead><tbody><tr><td className="py-2 px-4 border-b">Simple wood pergola (10x12 ft)</td><td className="py-2 px-4 border-b">$4,000–$8,000</td><td className="py-2 px-4 border-b">Cedar or pressure-treated pine</td></tr>
                  <tr><td className="py-2 px-4 border-b">Mid-range pergola (12x16 ft)</td><td className="py-2 px-4 border-b">$8,000–$15,000</td><td className="py-2 px-4 border-b">Cedar with decorative details</td></tr>
                  <tr><td className="py-2 px-4 border-b">Premium pergola (16x20 ft)</td><td className="py-2 px-4 border-b">$15,000–$30,000</td><td className="py-2 px-4 border-b">Cedar, custom design, lighting</td></tr>
                  <tr><td className="py-2 px-4 border-b">Aluminum/vinyl pergola</td><td className="py-2 px-4 border-b">$6,000–$20,000</td><td className="py-2 px-4 border-b">Low maintenance, various sizes</td></tr>
                  <tr><td className="py-2 px-4 border-b">Attached pergola (house-mounted)</td><td className="py-2 px-4 border-b">$5,000–$18,000</td><td className="py-2 px-4 border-b">Requires structural attachment</td></tr></tbody></table></div>
