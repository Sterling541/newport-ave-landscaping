        ...
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            ...
            <div className="bg-gray-100 p-6 rounded-lg mb-8 border-l-4" style={{ borderColor: 'oklch(0.46 0.20 25)' }}>
              ...
              <p>Our 1-year workmanship warranty on hardscape installations and a 90-day plant warranty on all plantings covers any settling or shifting that occurs due to workmanship. If a paver shifts in the first 5 years, we come back and fix it — at no cost to you.</p>
            </div>
