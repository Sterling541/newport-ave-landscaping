...
export default function IrrigationCulver() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'oklch(0.97 0.003 0)' }}>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: 'Irrigation Installation & Repair in Culver', url: '/service-areas/culver-irrigation' },
      ]} />
      <Navbar />
      <div style={{ paddingTop: '204px' }}>
        <div className="relative flex items-center justify-center" style={{ height:'380px',backgroundImage:'url(https://d2xsxph8kpxj0f.cloudfront.net/310519663503028182/g3pw3MRUapabcDUbhBEFxx/safe-hero-irrigation-wide-eEEjnzmEDfU9gNzL44jyPH.webp',backgroundSize:'cover',backgroundPosition:'center 50%' }}>
          ...
          <div className="relative text-center container">
            ...
            <h1 className="font-display text-white" style={{ fontSize:'clamp(1.8rem, 4vw, 3rem)',maxWidth:'700px',margin:'0 auto' }}>Irrigation Installation & Repair in Culver, Oregon</h1>
          </div>
        </div>
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            <p className="mb-8" style={{ fontSize:'1.05rem',lineHeight:1.85,color:'oklch(0.35 0.005 0)' }}>A properly designed irrigation system is the foundation of a healthy landscape in Culver's high desert climate. Newport Avenue Landscaping installs and repairs custom irrigation systems throughout Central Oregon, with certified technicians and a commitment to water efficiency.</p>

            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Irrigation Services in Culver</h2>
            <p className="mb-4">We design and install new sprinkler systems, repair existing systems, and provide fall winterization throughout Culver. Our certified irrigation technicians are licensed with the Oregon Landscape Contractors Board.</p>
            <p className="mb-8">A typical residential system in Culver costs $2,500–$6,000 for 5–10 zones. We provide detailed, itemized proposals after a site assessment.</p>

            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Winterization Is Critical in Central Oregon</h2>
            <p className="mb-4">Culver experiences hard freezes every winter. Without proper winterization, water left in your irrigation lines will freeze and crack pipes and fittings.</p>
            <div className="bg-gray-100 p-6 rounded-lg mb-8 border-l-4" style={{ borderColor: 'oklch(0.46 0.20 25)' }}>
              <p className="font-bold text-lg mb-2" style={{ color: 'oklch(0.25 0.005 0)' }}>PRO TIP</p>
              <p>Book your Culver sprinkler blowout before October 15th. We fill up fast once the first cold snap is forecast.</p>
            </div>
            <div className="p-8 text-center mt-12" style={{ backgroundColor: 'oklch(0.18 0.008 0)' }}>
              <p className="font-label text-xs mb-3" style={{ color:'oklch(0.46 0.20 25)',letterSpacing:'0.18em' }}>GET STARTED TODAY</p>
              <h3 className="font-display text-white mb-4" style={{ fontSize:'1.6rem' }}>Free Irrigation Consultation in Culver</h3>
              <p className="font-body mb-6" style={{ color:'oklch(0.72 0.005 0)',lineHeight:1.7 }}>Our certified irrigation team serves Culver year-round. Get a free system design and quote.</p>
