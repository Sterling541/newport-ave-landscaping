      ...
      <div style={{ paddingTop: '204px' }}>
        ...
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            <p className="mb-8" style={{ fontSize:'1.05rem',lineHeight:1.85,color:'oklch(0.35 0.005 0)' }}>Prineville is the county seat of Crook County, located 35 miles east of Bend. Newport Avenue Landscaping serves Prineville and the Crooked River Valley with the same quality and service as our Bend projects. We provide the full range of landscaping services — from paver patios and irrigation to xeriscape and lawn care — with our 90-day plant warranty and 1-year irrigation warranty on all installation projects.</p>
