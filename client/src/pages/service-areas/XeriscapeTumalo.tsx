...
export default function XeriscapeTumalo() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'oklch(0.97 0.003 0)' }}>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: 'Xeriscape Landscaping in Tumalo', url: '/service-areas/tumalo-xeriscape' },
      ]} />
      <Navbar />
      <div style={{ paddingTop: '328px' }}>
        <div className="relative flex items-center justify-center" style={{ height:'380px',backgroundImage:'url(https://d2xsxph8kpxj0f.cloudfront.net/310519663503028182/g3pw3MRUapabcDUbhBEFxx/ITP_7558_e52a40c9.jpg',backgroundSize:'cover',backgroundPosition:'center 50%' }}>
          ...
          <div className="relative text-center container">
            ...
            <h1 className="font-display text-white" style={{ fontSize:'clamp(1.8rem, 4vw, 3rem)',maxWidth:'700px',margin:'0 auto' }}>Xeriscape Landscaping in Tumalo, Oregon</h1>
          </div>
        </div>
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            <p className="mb-8" style={{ fontSize:'1.05rem',lineHeight:1.85,color:'oklch(0.35 0.005 0)' }}>Xeriscape landscaping is one of the smartest investments a Tumalo homeowner can make. By replacing water-hungry turf with drought-tolerant plants, decorative rock, and efficient drip irrigation, you can cut outdoor water use by 50–70% while creating a landscape that looks stunning year-round. Newport Avenue Landscaping has completed hundreds of xeriscape transformations across Central Oregon.</p>

            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Why Xeriscape Makes Sense in Tumalo</h2>
            <p className="mb-4">Tumalo sits in Oregon's high desert, receiving just 10–14 inches of rain per year. Traditional lawns fight this climate constantly — demanding frequent irrigation, fertilization, and mowing just to survive. Xeriscape works with the natural environment instead of against it.</p>
            <p className="mb-8">A well-designed xeriscape in Tumalo can reduce your water bill by $600–$1,500 per year. Combined with lower maintenance costs and potential rebates from local water utilities, the payback period is typically 3–5 years.</p>
            ...
            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Xeriscape Cost in Tumalo</h2>
            <p className="mb-4">A front yard xeriscape in Tumalo typically costs $8,000–$25,000 depending on square footage, design complexity, and whether existing turf needs removal.</p>
            ...
            <div className="p-8 text-center mt-12" style={{ backgroundColor: 'oklch(0.18 0.008 0)' }}>
              ...
              <h3 className="font-display text-white mb-4" style={{ fontSize:'1.6rem' }}>Free Xeriscape Consultation in Tumalo</h3>
              <p className="font-body mb-6" style={{ color:'oklch(0.72 0.005 0)',lineHeight:1.7 }}>Our xeriscape design team serves Tumalo and all of Central Oregon. We'll assess your property and provide a detailed proposal at no cost.</p>
