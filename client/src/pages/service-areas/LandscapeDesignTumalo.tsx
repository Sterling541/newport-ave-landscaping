      ...
      <div style={{ paddingTop: '204px' }}>
        ...
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            ...
            <p className="mb-4">We offer complimentary design consultations and detailed proposals with no obligation. Our industry-standard plant and irrigation warranties covers all hardscape projects.</p>
