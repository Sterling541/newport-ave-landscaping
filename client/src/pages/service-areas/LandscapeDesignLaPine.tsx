...
export default function LandscapeDesignLaPine() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'oklch(0.97 0.003 0)' }}>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: 'Landscape Design & Installation in La Pine', url: '/service-areas/la-pine-landscape-design' },
      ]} />
      <Navbar />
      <div style={{ paddingTop: '204px' }}>
        <div className="relative flex items-center justify-center" style={{ height:'380px',backgroundImage:'url(/manus-storage/safe-hero-landscape-design_5caa2e2e.jpg)',backgroundSize:'cover',backgroundPosition:'center 50%' }}>
          ...
          <div className="relative text-center container">
            ...
            <h1 className="font-display text-white" style={{ fontSize:'clamp(1.8rem, 4vw, 3rem)',maxWidth:'700px',margin:'0 auto' }}>Landscape Design & Installation in La Pine, Oregon</h1>
          </div>
        </div>
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            <p className="mb-8" style={{ fontSize:'1.05rem',lineHeight:1.85,color:'oklch(0.35 0.005 0)' }}>A professionally designed landscape transforms a property — increasing curb appeal, adding outdoor living space, and boosting home value. Newport Avenue Landscaping provides full-service landscape design and installation throughout La Pine, from initial concept through final planting. Our design team has completed hundreds of projects across Central Oregon.</p>

            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Our Landscape Design Process in La Pine</h2>
            ...
            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Landscape Design Cost in La Pine</h2>
            <p className="mb-4">Full landscape design and installation in La Pine typically ranges from $15,000 to $80,000+ depending on scope. Smaller projects like a front yard refresh or patio addition start around $8,000–$15,000.</p>
            ...
            <div className="bg-gray-100 p-6 rounded-lg mb-8 border-l-4" style={{ borderColor: 'oklch(0.46 0.20 25)' }}>
              ...
              <p>The best time to start a landscape project in La Pine is late spring (May–June) or early fall (August–September) when temperatures are moderate and plants establish quickly.</p>
            </div>
            <div className="p-8 text-center mt-12" style={{ backgroundColor: 'oklch(0.18 0.008 0)' }}>
              <p className="font-label text-xs mb-3" style={{ color:'oklch(0.46 0.20 25)',letterSpacing:'0.18em' }}>GET STARTED TODAY</p>
              <h3 className="font-display text-white mb-4" style={{ fontSize:'1.6rem' }}>Free Landscape Design Consultation in La Pine</h3>
              <p className="font-body mb-6" style={{ color:'oklch(0.72 0.005 0)',lineHeight:1.7 }}>Our design team serves La Pine and all of Central Oregon. We'll visit your property, discuss your vision, and provide a detailed proposal at no cost.</p>
