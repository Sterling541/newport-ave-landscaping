      ...
      <div style={{ paddingTop: '204px' }}>
        ...
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            ...
            <p className="mb-4">We've built a reputation in NorthWest Crossing for showing up on time, communicating clearly, and delivering work that holds up. Our 1-year workmanship warranty on hardscape installations and a 90-day plant warranty on all plantings is unique in Central Oregon.</p>
