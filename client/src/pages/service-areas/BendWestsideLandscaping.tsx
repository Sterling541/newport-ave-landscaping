...
export default function BendWestsideLandscaping() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'oklch(0.97 0.003 0)' }}>
      <SEO
        ...
        canonical="https://newportavelandscaping.com/service-areas/bend-westside-landscaping"
      />
      <BreadcrumbSchema items={[
        { name: 'Home', url: '/' },
        { name: 'Service Areas', url: '/service-areas' },
        { name: "Bend's Westside Landscaping", url: '/service-areas/bend-westside-landscaping' },
      ]} />
      <Navbar />
      <div style={{ paddingTop: '204px' }}>
        <div className="relative flex items-center justify-center" style={{ height:'380px',backgroundImage:'url(https://d2xsxph8kpxj0f.cloudfront.net/310519663503028182/g3pw3MRUapabcDUbhBEFxx/east-bend-install-01_5ad4daf3.jpg',backgroundSize:'cover',backgroundPosition:'center 50%' }}>
          ...
          <div className="relative text-center container">
            <p className="font-label mb-3" style={{ color:'oklch(0.72 0.12 25)',fontSize:'0.7rem',letterSpacing:'0.18em' }}>BEND'S WESTSIDE · BEND, OREGON &middot; 2024</p>
            <h1 className="font-display text-white" style={{ fontSize:'clamp(1.8rem, 4vw, 3rem)',maxWidth:'700px',margin:'0 auto' }}>Landscaping Services in Bend's Westside, Bend, Oregon</h1>
          </div>
        </div>
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            ...
            <p className="mb-4">We've built a reputation in Bend's Westside for showing up on time, communicating clearly, and delivering work that holds up. Our 5-year warranty on all hardscape projects is unique in Central Oregon.</p>
            ...
            <div className="bg-gray-100 p-6 rounded-lg mb-8 border-l-4" style={{ borderColor: 'oklch(0.46 0.20 25)' }}>
              ...
              <p>We offer free on-site consultations throughout Bend's Westside. Our design team will walk your property, discuss your goals, and provide a detailed proposal — no pressure, no obligation.</p>
            </div>
            <div className="p-8 text-center mt-12" style={{ backgroundColor: 'oklch(0.18 0.008 0)' }}>
              <p className="font-label text-xs mb-3" style={{ color:'oklch(0.46 0.20 25)',letterSpacing:'0.18em' }}>GET STARTED TODAY</p>
              <h3 className="font-display text-white mb-4" style={{ fontSize:'1.6rem' }}>Get a Free Landscaping Quote in Bend's Westside</h3>
              <p className="font-body mb-6" style={{ color:'oklch(0.72 0.005 0)',lineHeight:1.7 }}>Our team works regularly in Bend's Westside. Contact us for a free on-site consultation and detailed proposal.</p>
