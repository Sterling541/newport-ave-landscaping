...
export default function LawnCareCulver() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'oklch(0.97 0.003 0)' }}>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: 'Lawn Care & Maintenance in Culver', url: '/service-areas/culver-lawn-care' },
      ]} />
      <Navbar />
      <div style={{ paddingTop: '204px' }}>
        <div className="relative flex items-center justify-center" style={{ height:'380px',backgroundImage:'url(https://d2xsxph8kpxj0f.cloudfront.net/310519663503028182/g3pw3MRUapabcDUbhBEFxx/hero-lawn-care-mQg45uakvrD39QTNERiss9.webp',backgroundSize:'cover',backgroundPosition:'center 50%' }}>
          ...
          <div className="relative text-center container">
            ...
            <h1 className="font-display text-white" style={{ fontSize:'clamp(1.8rem, 4vw, 3rem)',maxWidth:'700px',margin:'0 auto' }}>Lawn Care & Maintenance in Culver, Oregon</h1>
          </div>
        </div>
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            <p className="mb-8" style={{ fontSize:'1.05rem',lineHeight:1.85,color:'oklch(0.35 0.005 0)' }}>Newport Avenue Landscaping provides comprehensive lawn care services throughout Culver, including weekly mowing, seasonal cleanups, aeration, fertilization, and weed control. Our Everything Residential Maintenance Plan covers it all — starting at $388/month.</p>

            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Lawn Care Services in Culver</h2>
            ...
            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Lawn Care Pricing in Culver</h2>
            <p className="mb-4">Our Everything Residential Maintenance Plan starts at $388/month for a typical Culver home. We provide free consultations and will assess your lawn's current condition before recommending a care plan.</p>
            ...
            <div className="p-8 text-center mt-12" style={{ backgroundColor: 'oklch(0.18 0.008 0)' }}>
              ...
              <h3 className="font-display text-white mb-4" style={{ fontSize:'1.6rem' }}>Get a Free Lawn Care Quote in Culver</h3>
              <p className="font-body mb-6" style={{ color:'oklch(0.72 0.005 0)',lineHeight:1.7 }}>We serve Culver and all of Central Oregon. Tell us about your lawn and we'll put together a custom care plan.</p>
