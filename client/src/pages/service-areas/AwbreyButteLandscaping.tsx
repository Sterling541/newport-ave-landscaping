      ...
      <div style={{ paddingTop: '204px' }}>
        ...
        <div className="container py-16 max-w-3xl mx-auto">
          ...
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            ...
            <p className="mb-4" style={{ color:'oklch(0.30 0.008 0)',lineHeight:1.85,fontSize:'1.05rem' }}>We've built a reputation in Awbrey Butte for showing up on time, communicating clearly, and delivering work that holds up. Our 1-year workmanship warranty on hardscape installations and a 90-day plant warranty on all plantings are backed by 21+ years of experience in Central Oregon's demanding climate. We're licensed with the Oregon Landscape Contractors Board (LCB #9153), fully insured, and have a team of 150+ employees — large enough to handle any project, local enough to care about every detail.</p>
