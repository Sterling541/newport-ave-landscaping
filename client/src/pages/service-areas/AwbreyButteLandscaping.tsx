      ...
      <div style={{ paddingTop: '204px' }}>
        ...
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            <p className="mb-8" style={{ fontSize:'1.05rem',lineHeight:1.85,color:'oklch(0.35 0.005 0)' }}>Newport Avenue Landscaping has worked in Awbrey Butte for over 21 years. We know the specific soil conditions, HOA requirements, and design aesthetic that fits this part of Bend. Whether you need a new paver patio, landscape renovation, irrigation installation, or ongoing lawn maintenance, our team delivers the same craftsmanship and 5-year warranty to every project.</p>

            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Services We Provide in Awbrey Butte</h2>
            ...
            <p className="mb-4">We've built a reputation in Awbrey Butte for showing up on time, communicating clearly, and delivering work that holds up. Our 5-year warranty on all hardscape projects is unique in Central Oregon.</p>
            ...
            <div className="bg-gray-100 p-6 rounded-lg mb-8 border-l-4" style={{ borderColor: 'oklch(0.46 0.20 25)' }}>
              ...
              <p>We offer free on-site consultations throughout Awbrey Butte. Our design team will walk your property, discuss your goals, and provide a detailed proposal — no pressure, no obligation.</p>
            </div>
            <div className="p-8 text-center mt-12" style={{ backgroundColor: 'oklch(0.18 0.008 0)' }}>
              ...
              <p className="font-body mb-6" style={{ color:'oklch(0.72 0.005 0)',lineHeight:1.7 }}>Our team works regularly in Awbrey Butte. Contact us for a free on-site consultation and detailed proposal.</p>
