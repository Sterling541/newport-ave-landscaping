    ...
    <div className="min-h-screen" style={{ backgroundColor: "oklch(0.985 0.006 80)" }}>
      ...
      <div className="container py-16 max-w-3xl mx-auto">
        <div style={{ color: "oklch(0.25 0.005 0)" }}>
          ...
          <p className="mb-8" style={{ lineHeight: 1.8 }}>
            We're licensed with the Oregon Landscape Contractors Board (LCB #9153), fully insured, and have a team of 150+ employees. We show up on schedule, communicate throughout the project, and back every hardscape installation with a 1-year workmanship warranty.
          </p>
          ...
          <div className="p-8 text-center mt-4" style={{ backgroundColor: "oklch(0.15 0.005 0)" }}>
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-6">
              ...
              <span style={{ color: "oklch(0.55 0.005 0)", fontSize: "0.75rem" }}>✓ 1-Year Workmanship Warranty</span>
            </div>
          </div>
