...
export default function PaverPatioPrineville() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'oklch(0.97 0.003 0)' }}>
      <SEO
        ...
        canonical="https://newportavelandscaping.com/service-areas/prineville-paver-patio"
      />
      <BreadcrumbSchema items={[
        { name: 'Home', url: '/' },
        { name: 'Service Areas', url: '/service-areas' },
        { name: 'Paver Patio Installation in Prineville', url: '/service-areas/prineville-paver-patio' },
      ]} />
      <Navbar />
      <div style={{ paddingTop: '204px' }}>
        <div className="relative flex items-center justify-center" style={{ height:'380px',backgroundImage:'url(https://d2xsxph8kpxj0f.cloudfront.net/310519663503028182/g3pw3MRUapabcDUbhBEFxx/paver-patio-and-gas-firepit-01_04c71c72.jpg',backgroundSize:'cover',backgroundPosition:'center 50%' }}>
          ...
          <div className="relative text-center container">
            ...
            <h1 className="font-display text-white" style={{ fontSize:'clamp(1.8rem, 4vw, 3rem)',maxWidth:'700px',margin:'0 auto' }}>Paver Patio Installation in Prineville, Oregon</h1>
          </div>
        </div>
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            <p className="mb-8" style={{ fontSize:'1.05rem',lineHeight:1.85,color:'oklch(0.35 0.005 0)' }}>Newport Avenue Landscaping has designed and installed paver patios throughout Central Oregon for over 21 years, including dozens of projects in Prineville. We bring the same craftsmanship, licensed crew, and 5-year workmanship warranty to every project — whether it's a simple backyard patio or a full outdoor living space with fire pit and built-in seating.</p>

            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Why Prineville Homeowners Choose Pavers</h2>
            ...
            <p className="mb-8">Our Prineville patio projects range from $8,000 for a simple backyard patio to $45,000+ for a full outdoor living space. We provide free, itemized proposals after an on-site consultation.</p>
            ...
            <div className="bg-gray-100 p-6 rounded-lg mb-8 border-l-4" style={{ borderColor: 'oklch(0.46 0.20 25)' }}>
              ...
              <p>In Prineville's climate, proper base preparation is everything. We install a minimum 6-inch compacted gravel base to prevent frost heaving and ensure your patio stays level for decades.</p>
            </div>
            <div className="p-8 text-center mt-12" style={{ backgroundColor: 'oklch(0.18 0.008 0)' }}>
              <p className="font-label text-xs mb-3" style={{ color:'oklch(0.46 0.20 25)',letterSpacing:'0.18em' }}>GET STARTED TODAY</p>
              <h3 className="font-display text-white mb-4" style={{ fontSize:'1.6rem' }}>Get a Free Patio Quote in Prineville</h3>
              <p className="font-body mb-6" style={{ color:'oklch(0.72 0.005 0)',lineHeight:1.7 }}>We serve Prineville and all of Central Oregon. Our design team will visit your property and provide a detailed proposal at no cost.</p>
