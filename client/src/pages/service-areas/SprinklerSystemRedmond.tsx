...
export default function SprinklerSystemRedmond() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'oklch(0.97 0.003 0)' }}>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: 'Sprinkler System Installation in Redmond', url: '/service-areas/redmond-sprinkler-system' },
      ]} />
      <Navbar />
      <div style={{ paddingTop: '204px' }}>
        <div className="relative flex items-center justify-center" style={{ height:'380px',backgroundImage:'url(https://d2xsxph8kpxj0f.cloudfront.net/310519663503028182/g3pw3MRUapabcDUbhBEFxx/safe-hero-irrigation-wide-eEEjnzmEDfU9gNzL44jyPH.webp',backgroundSize:'cover',backgroundPosition:'center 50%' }}>
          ...
          <div className="relative text-center container">
            ...
            <h1 className="font-display text-white" style={{ fontSize:'clamp(1.8rem, 4vw, 3rem)',maxWidth:'700px',margin:'0 auto' }}>Sprinkler System Installation in Redmond, Oregon</h1>
          </div>
        </div>
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            <p className="mb-8" style={{ fontSize:'1.05rem',lineHeight:1.85,color:'oklch(0.35 0.005 0)' }}>A properly designed sprinkler system is the foundation of a healthy landscape in Central Oregon's high desert climate. Newport Avenue Landscaping installs custom irrigation systems throughout Redmond, designing each system around your specific soil conditions, plant types, and water pressure. Our certified irrigation technicians are licensed with the Oregon Landscape Contractors Board.</p>

            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Irrigation Design for Redmond Properties</h2>
            <p className="mb-4">Every property in Redmond is different — lot size, soil type, plant selection, and water pressure all affect system design. We start every project with a thorough site assessment and water pressure test before designing your zone layout.</p>
            <p className="mb-4">A typical residential system in Redmond costs between $2,500 and $6,000 for 5–10 zones. We provide detailed, itemized proposals so you know exactly what you're getting.</p>
            <div className="overflow-x-auto mb-8"><table className="min-w-full bg-white border border-gray-300"><thead><tr><th className="py-2 px-4 border-b text-left">System Type</th><th className="py-2 px-4 border-b text-left">Typical Cost</th><th className="py-2 px-4 border-b text-left">Best For</th></tr></thead><tbody><tr><td className="py-2 px-4 border-b">Spray zones (lawn)</td><td className="py-2 px-4 border-b">$500–$700/zone</td><td className="py-2 px-4 border-b">Turf areas</td></tr>
                  ...
                  <tr><td className="py-2 px-4 border-b">Full residential system</td><td className="py-2 px-4 border-b">$2,500–$6,000</td><td className="py-2 px-4 border-b">Average home in Redmond</td></tr></tbody></table></div>

            <h2 className="text-3xl font-bold mb-4" style={{ color: 'oklch(0.25 0.005 0)' }}>Winterization Is Essential in Central Oregon</h2>
            <p className="mb-4">Redmond experiences hard freezes every winter. Without proper winterization, water left in your irrigation lines will freeze, expand, and crack pipes and fittings — repairs that can cost $500–$2,000 or more.</p>
            <p className="mb-4">We offer fall blowout service throughout Redmond and recommend scheduling before October 15th — the average first hard freeze date in Central Oregon.</p>
            <div className="bg-gray-100 p-6 rounded-lg mb-8 border-l-4" style={{ borderColor: 'oklch(0.46 0.20 25)' }}>
              <p className="font-bold text-lg mb-2" style={{ color: 'oklch(0.25 0.005 0)' }}>PRO TIP</p>
              <p>Book your Redmond sprinkler blowout before September 30th to guarantee a spot on our schedule. We fill up fast once the first cold snap is forecast.</p>
            </div>
            <div className="p-8 text-center mt-12" style={{ backgroundColor: 'oklch(0.18 0.008 0)' }}>
              <p className="font-label text-xs mb-3" style={{ color:'oklch(0.46 0.20 25)',letterSpacing:'0.18em' }}>GET STARTED TODAY</p>
              <h3 className="font-display text-white mb-4" style={{ fontSize:'1.6rem' }}>Free Irrigation Consultation in Redmond</h3>
              <p className="font-body mb-6" style={{ color:'oklch(0.72 0.005 0)',lineHeight:1.7 }}>Our certified irrigation team serves Redmond year-round. Get a free system design and quote — no obligation.</p>
