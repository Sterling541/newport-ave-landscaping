      ...
      <div style={{ paddingTop: '204px' }}>
        ...
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            <p className="mb-8" style={{ fontSize:'1.05rem',lineHeight:1.85,color:'oklch(0.35 0.005 0)' }}>Crooked River Ranch is a planned community in Jefferson County, known for its high desert setting and stunning views. Newport Avenue Landscaping serves Crooked River Ranch homeowners and the HOA. We provide the full range of landscaping services with our 5-year workmanship warranty on all hardscape projects.</p>
            ...
            <p className="mb-8">We're licensed with the Oregon Landscape Contractors Board (LCB #9153), fully insured, and offer a 5-year warranty on all hardscape projects.</p>
