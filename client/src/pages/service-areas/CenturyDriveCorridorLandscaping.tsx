      ...
      <div style={{ paddingTop: '204px' }}>
        ...
        <div className="container py-16 max-w-3xl mx-auto">
          <div style={{ color: 'oklch(0.25 0.005 0)' }}>
            ...
            <p className="mb-4">We've built a reputation in Century Drive Corridor for showing up on time, communicating clearly, and delivering work that holds up. Our 90-day plant warranty and 1-year irrigation warranty is unique in Central Oregon.</p>
