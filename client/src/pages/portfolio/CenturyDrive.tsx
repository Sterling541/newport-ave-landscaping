...
export default function CenturyDrive() {
  return (
    <PortfolioProjectLayout
      ...
      heroImage="https://newportavelandscaping.com/wp-content/uploads/2022/05/century-drive-bend-oregon-stream-pondless-water-feature-enhancement-front-view.jpg"
      ...
      images={[
        { src: "https://newportavelandscaping.com/wp-content/uploads/2022/05/century-drive-bend-oregon-stream-pondless-water-feature-enhancement-front-view.jpg", alt: "Century Drive Water Feature" },
      ]}
