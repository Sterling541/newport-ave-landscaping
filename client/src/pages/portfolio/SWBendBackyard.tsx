...
export default function SWBendBackyard() {
  return (
    <PortfolioProjectLayout
      ...
      heroImage="https://newportavelandscaping.com/wp-content/uploads/2022/05/south-west-bend-oregon-campground-backyard-full-view-2.jpg"
      ...
      images={[
        { src: "https://newportavelandscaping.com/wp-content/uploads/2022/05/south-west-bend-oregon-campground-backyard-full-view-2.jpg", alt: "SW Bend Backyard Full View" },
        { src: "https://newportavelandscaping.com/wp-content/uploads/2022/05/south-east-bend-oregon-backyard-landscape-renovation-after-photo-1.jpg", alt: "SW Bend Backyard Detail" },
      ]}
      ...
      relatedProjects={[
        ...
        { title: "Backyard Landscape Renovation", href: "/portfolio/backyard-renovation", image: "https://newportavelandscaping.com/wp-content/uploads/2022/05/south-east-bend-oregon-backyard-landscape-renovation-after-photo-1-2-768x512.jpg" },
