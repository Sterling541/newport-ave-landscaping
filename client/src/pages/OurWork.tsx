      ...
      <section className="py-8 border-b" style={{ borderColor: "oklch(0.22 0.005 0)", backgroundColor: "oklch(0.15 0.005 0)" }}>
        <div className="container flex flex-wrap items-center gap-4">
          <button
            ...
            style={{
              borderRadius: "0 2rem 2rem 0.2rem",
          ...
          {activeTab === "featured" && (
            <div className="flex flex-wrap gap-2 ml-4">
              <button
                ...
                style={{
                  borderRadius: "0 1.5rem 1.5rem 0.15rem",
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    {project.tags.map((tag) => (
                      <span key={tag} className="font-label px-3 py-1" style={{ backgroundColor: "oklch(0.46 0.20 25 / 0.18)", color: "oklch(0.72 0.12 25)", borderRadius: "0 1rem 1rem 0.15rem", fontSize: "0.58rem" }}>
                        {tag}
                      </span>
                    ))}
                  </div>
