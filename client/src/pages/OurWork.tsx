...
const SUCHY_PHOTOS = [
  `${CDN}/BtVKYdoDFtosJiYr_7d11e8ac.jpg`,
  `${CDN}/RZkLIoYMRXODAyCM_055d64f2.jpg`,
  `${CDN}/FtMttJUoHHZYCbdj_4b4603ec.jpg`,
  `${CDN}/WqyzyvCIFmwwLVwf_9b3c8e87.jpg`,
  `${CDN}/BJQnCBIWBSxkYjCM_926b3953.jpg`,
  `${CDN}/iHdfAFSCcUmMCmib_7debc273.jpg`,
  `${CDN}/psygNYWgbbViJaiG_d4bac57c.jpg`,
  `${CDN}/YQEtbwcOGdASglsf_35271644.jpg`,
  `${CDN}/bbjjzgIJIeHzaqSk_6c9bcc0a.jpg`,
];

const HOSMER_PHOTOS = [
  `${CDN}/OAhyShvnyMXUNJqn_d922ba95.jpg`,
  `${CDN}/ydYuxCwLwzvNoXNQ_43a3e94e.jpg`,
  `${CDN}/UWAoTStKXXBmOBMu_044596e7.jpg`,
  `${CDN}/XdRaSxrsEsCUxGCF_1251267c.jpg`,
  `${CDN}/QfQcioagkxhCEHdy_db0576e4.jpg`,
  `${CDN}/QuZbCMdvWnmWDtAV_3204cac4.jpg`,
  `${CDN}/CzvUNmVAPgQRRbCL_e2d80391.jpg`,
  `${CDN}/lVVEgyfcxeKKnmyY_59a546be.jpg`,
  `${CDN}/zCMVyaDdngZZHvwY_1af7886e.jpg`,
  `${CDN}/oFCNJlnwxjSikzrO_47376b63.jpg`,
  `${CDN}/CIvaeoiJEjdrssec_3cf9c660.jpg`,
  `${CDN}/woXXsjlTaYTOCsnM_c403d649.jpg`,
  `${CDN}/lqqurINoAUnLOUdf_fc9f139c.jpg`,
  `${CDN}/TBxIerDoaHLuautE_de4e5190.jpg`,
  `${CDN}/ImggzCVNnPnepqYO_411a0bdd.jpg`,
  `${CDN}/owHRteEIGGvRycKl_61969e24.jpg`,
  `${CDN}/KLMrOoOjCHESBbXd_939fd8ec.jpg`,
];

const MCGRATH_PHOTOS = [
  `${CDN}/DsCDLoIMQbfZSjuQ_f6ac971b.jpg`,
  `${CDN}/iLQzysWAIpshLExs_8c4295c4.jpg`,
  `${CDN}/GnijvQODFDMrKxrg_129e4e70.jpg`,
  `${CDN}/uTOcvbcZVEyEexUs_e79b2bb9.jpg`,
  `${CDN}/RDRaedrdxFWkLZJv_919b00e5.jpg`,
  `${CDN}/retHcMWUuJjuarBk_f9f6c55f.jpg`,
  `${CDN}/ambqMQAjmNxaGfTz_a9570287.jpg`,
  `${CDN}/znXAXegIgUZJRcee_c6ffe84f.jpg`,
  `${CDN}/EyuWkxTqMKjupGHj_fc5dc55a.jpg`,
  `${CDN}/YvOMYOfUTJLIYxhZ_19c14070.jpg`,
  `${CDN}/PtamSQtLZMVcIwap_6e7b886a.jpg`,
  `${CDN}/fCBGPaTPIXfgNAhf_757f15f5.jpg`,
  `${CDN}/VErORHNoPueeEPkG_21be7f3a.jpg`,
  `${CDN}/fcRknhIBupDkiSPP_7321f8be.jpg`,
  `${CDN}/cgCFmZdHHBxadBtL_4e8ea656.jpg`,
  `${CDN}/iIASQJimTxkHYTiX_4f997257.jpg`,
  `${CDN}/veogFfZmynMseowj_21eba8d7.jpg`,
  `${CDN}/tHsXSKcevhyhsRjZ_79ab8584.jpg`,
  `${CDN}/hIxjTkMgIukczrmz_fe7a0b9d.jpg`,
  `${CDN}/CrNsPnwGSyMrKqea_6ade24ba.jpg`,
];
