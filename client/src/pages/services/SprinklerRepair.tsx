...
export default function SprinklerRepair() {
  return (
    <ServicePageLayout
      ...
      heroImage="https://d2xsxph8kpxj0f.cloudfront.net/310519663503028182/g3pw3MRUapabcDUbhBEFxx/safe-hero-sprinkler-repair-BPmCL9bZbyshSLhxmjSuBV.webp"
      ...
      galleryImages={[
        { src: "https://d2xsxph8kpxj0f.cloudfront.net/310519663503028182/g3pw3MRUapabcDUbhBEFxx/safe-hero-sprinkler-repair-BPmCL9bZbyshSLhxmjSuBV.webp", alt: "Sprinkler repair technician inspecting irrigation head in Bend Oregon" },
