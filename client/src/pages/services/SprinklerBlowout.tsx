...
export default function SprinklerBlowout() {
  return (
    <ServicePageLayout
      ...
      heroImage="/manus-storage/safe-hero-sprinkler-blowout_4fdd4475.jpg"
      ...
      galleryImages={[
        { src: "/manus-storage/safe-hero-sprinkler-blowout_4fdd4475.jpg", alt: "Sprinkler winterization blowout service in Bend Oregon" },
        { src: "/manus-storage/svc-sprinkler-blowout-2_5b483c3e.jpg", alt: "Irrigation system blowout with air compressor in Central Oregon" },
        { src: "/manus-storage/safe-hero-sprinkler-blowout_4fdd4475.jpg", alt: "Fall sprinkler blowout and winterization service in Bend Oregon" },
      ]}
      ...
      faqs={[
          ...
          { question: "What happens if I skip the sprinkler blowout in Bend?", answer: "Water left in irrigation pipes, valves, and heads during a Bend winter freeze expands as it turns to ice and can crack PVC pipe, split poly tubing, break spray heads, damage valve bodies, and destroy backflow preventers. A single freeze event can cause $500–$3,000 in repair costs. A professional blowout costs $140–$175 and takes less than an hour — it is one of the best investments you can make in your irrigation system." },
          { question: "Do you also do sprinkler spring activation in Bend?", answer: "Yes — Newport Avenue Landscaping offers sprinkler system spring startup and activation at the same $140/tech hour rate. We pressurize the system, check all zones, test and adjust heads, inspect the backflow preventer, and program your controller for the season. Scheduling your spring activation and fall blowout together as an annual package saves time and ensures your system runs perfectly all season." },
          { question: "Can I blow out my own sprinklers in Bend?", answer: "It is possible but not recommended. Most homeowners use small 20–30 CFM shop compressors that cannot fully evacuate all zones in one pass, leaving water in low spots and valve bodies. Over-pressurizing (above 50 PSI for poly pipe, 80 PSI for PVC) can also damage heads and valves. Our commercial 185 CFM compressors deliver the correct airflow for complete evacuation without equipment damage. The cost of a professional blowout is far less than a single freeze repair." },
          { question: "Do you offer sprinkler blowouts in Redmond and Sisters, Oregon?", answer: "Yes — Newport Avenue Landscaping performs sprinkler winterization throughout Central Oregon including Bend, Redmond, Tumalo, Sisters, Sunriver, and La Pine. We run dedicated blowout routes in each area each fall. We are Oregon LCB licensed (#9153) and have been winterizing irrigation systems in Central Oregon since 2005. Book early — our October schedule fills by mid-September." },
      ]}
    />
  );
}
