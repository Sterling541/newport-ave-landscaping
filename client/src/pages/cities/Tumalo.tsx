...
export default function TumaloPage() {
  return (
    <CityPageLayout
      city="Tumalo"
      ...
      services={[
        ...
        { icon: "sprinklers", name: "Tumalo Irrigation Systems", description: "Efficient irrigation is vital for Tumalo's landscapes, especially with access to irrigation district water. Our experts design, install, and maintain smart irrigation systems that conserve water while keeping your plants hydrated and thriving in the local climate. We also perform annual sprinkler activations in spring and blowouts in fall to protect your system from Tumalo's hard winter freezes.", href: "/services/irrigation" },
        { icon: "design", name: "Custom Landscape Design in Tumalo", description: "From conceptualization to completion, our landscape design services transform your Tumalo acreage into a personalized outdoor oasis. We create CAD-based design plans that integrate native plants, sustainable practices, and thoughtful hardscaping that complements Tumalo's rural aesthetic and climate. Our designers are experienced with the larger lot sizes and varied terrain typical of Tumalo properties.", href: "/services/landscape-design" },
        { icon: "outdoor", name: "Outdoor Living Spaces for Tumalo Homes", description: "Enhance your Tumalo home with custom outdoor living features like paver patios, fire pits, outdoor kitchens, and pergolas. We create functional and beautiful spaces perfect for enjoying Tumalo's serene evenings and expansive views of the Cascades and high desert. Tumalo's larger lots often allow for outdoor living spaces that simply are not possible on smaller suburban properties.", href: "/services/outdoor-living" },
        { icon: "architecture", name: "Xeriscaping & Fire-Wise Landscaping", description: "Given Tumalo's high-desert climate and proximity to the urban-wildland interface, xeriscaping and fire-wise design are excellent choices for water conservation, low maintenance, and property protection. Our designs incorporate beautiful, drought-tolerant plants that flourish in Tumalo's conditions while creating the defensible space zones recommended by fire safety experts.", href: "/services/xeriscaping" },
        { icon: "commercial", name: "Commercial Landscaping & Snow Removal", description: "Newport Avenue Landscaping provides reliable commercial landscaping and snow removal services for businesses and properties throughout Tumalo. We ensure your commercial space is well-maintained year-round, reflecting professionalism and care. Our equipment and crew size allow us to handle large-scale commercial and rural properties efficiently.", href: "/services/snow-removal" },
      ]}
      whyUs={[
      ...
      nearbyAreas={[
        ...
        { label: "Alfalfa", href: "/landscaping/alfalfa" },
      ...
      faqs={[
        { question: "How much does landscaping cost in Tumalo, Oregon?", answer: "Landscaping costs in Tumalo vary widely based on project scope and materials. For basic lawn care services, residents can expect to pay from $97 per service. Larger projects like seasonal cleanups typically start from $600, while irrigation system installations can range from $1,600 to $2,000 per zone. Full landscape design and installation projects, especially for Tumalo's larger acreage properties, can range from $15,000 to $80,000+, depending on complexity and features. We provide detailed, transparent written estimates after a free site visit." },
        { question: "What landscaping services does Newport Avenue offer in Tumalo?", answer: "Newport Avenue Landscaping offers a comprehensive suite of services tailored for Tumalo properties. This includes expert lawn care and maintenance, custom landscape design, efficient irrigation system installation and repair, and the creation of stunning outdoor living spaces with patios, fire features, and pergolas. We also specialize in xeriscaping, fire-wise landscaping, retaining walls, landscape lighting, and commercial landscaping solutions, all designed to thrive in Tumalo's unique climate and rural setting." },
        { question: "Is Newport Avenue Landscaping licensed and insured in Oregon?", answer: "Yes. Newport Avenue Landscaping holds Oregon Landscape Contractor Bond #9153 (LCB #9153). We are fully licensed, bonded, and insured for all residential and commercial landscaping work in Tumalo and throughout Central Oregon. All work is performed by our own employees -- we never use subcontractors -- ensuring accountability and consistent quality on every project." },
        { question: "Do you offer free estimates in Tumalo, Oregon?", answer: "Absolutely. Newport Avenue Landscaping is pleased to offer free, no-obligation estimates for all potential landscaping projects in Tumalo, Oregon. We pride ourselves on a quick response time, typically within 24–48 hours, to schedule a convenient site visit. During this visit, our experts will assess your property, discuss your vision, and provide a detailed written quote tailored to your specific needs and the unique characteristics of your Tumalo landscape." },
        { question: "What areas of Tumalo do you serve?", answer: "We proudly serve all key areas within and around Tumalo, Oregon. This includes properties along the Tumalo Creek corridor, expansive rural acreage, homes near Tumalo State Park, and residences along the Tumalo Road corridor. Our services also extend to the Cline Falls area and other surrounding communities, ensuring comprehensive coverage for the entire Tumalo region." },
