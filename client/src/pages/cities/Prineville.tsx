...
export default function PrinevillePage() {
  return (
    <CityPageLayout
      ...
      intro="Newport Avenue Landscaping has proudly served the Prineville community for many years, bringing our expertise and passion for outdoor spaces to homes and businesses across Crook County. Prineville is Central Oregon's oldest city, and its combination of historic charm, agricultural heritage, and newer residential growth creates a diverse range of landscaping needs that our team is well-equipped to address. We understand the unique character of Prineville, from the historic downtown and the Ochoco Creek corridor to the expansive properties near Ochoco Reservoir and the newer developments around Meadow Lakes Golf Course. Prineville's setting -- surrounded by the Ochoco Mountains and the high desert of Crook County -- creates a distinctive landscape context that rewards designs that draw from the local environment rather than fighting it. Our team is dedicated to enhancing the natural beauty of this high-desert landscape, creating stunning and sustainable outdoor environments that thrive in Prineville's distinct climate. Whether you are looking for a comprehensive lawn care program, a custom xeriscape design that embraces Crook County's dry conditions, or a complete outdoor living transformation with a patio and fire feature for those cool Prineville evenings, Newport Avenue delivers the same quality and craftsmanship to Prineville that we bring to every community we serve. All work is performed by our own licensed crew -- we never use subcontractors -- and every installation project is backed by our 1-year workmanship warranty on hardscape installations and a 90-day plant warranty on all plantings."
      communityNote="Prineville's climate, characterized by warmer summers and colder winters than Bend, presents specific landscaping considerations for local homeowners and businesses. Situated in USDA Zone 6a, the area experiences a more continental climate with less annual precipitation than Bend -- Prineville receives roughly 10 inches of rain per year -- which makes efficient irrigation and drought-tolerant plant selection essential for any successful Prineville landscape. The local soil is often a mix of volcanic ash and clay, which can create drainage challenges in some areas and requires careful amendment to support healthy plant growth. Prineville's terrain also varies significantly across the city: properties near the Ochoco Creek corridor have riparian soil conditions and access to water that create different opportunities than the drier upland properties near Meadow Lakes or the hillside lots with views of the Ochoco Mountains. The city's agricultural heritage also means that many Prineville properties are larger than typical suburban lots, with opportunities for fruit trees, vegetable gardens, and large irrigated areas alongside ornamental beds. Our designers are experienced with the full range of Prineville property types and soil conditions, and we tailor every design to the specific site, goals, and budget of each client. We are also familiar with Crook County's permitting requirements for retaining walls, irrigation systems, and other landscape improvements."
      services={[
