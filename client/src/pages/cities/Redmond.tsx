...
export default function RedmondPage() {
  return (
    <CityPageLayout
      ...
      seoTitle="Landscaping Company Redmond Oregon | City-Preferred Vendor | Newport Avenue Landscaping"
      seoDescription="Newport Avenue Landscaping — one of only 2 City of Redmond preferred landscape vendors. Serving Redmond since 2005 with lawn care, irrigation, landscape design, xeriscaping & snow removal. Licensed & Bonded LCB #9153. Free estimates."
