...
export default function BendPage() {
  return (
    <CityPageLayout
      ...
      seoTitle="Landscaping Company Bend Oregon | Newport Avenue Landscaping"
      seoDescription="Bend's premier landscaping company since 2005. Lawn care, irrigation, landscape design, xeriscaping, pavers & outdoor living in Bend, OR. Licensed & Bonded LCB #9153. Free estimates."
