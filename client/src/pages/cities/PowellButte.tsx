...
export default function PowellButtePage() {
  return (
    <CityPageLayout
      ...
      whyUs={[
        "Over 21 years of experience serving rural Central Oregon properties, including large ranches, farms, and horse properties in the Powell Butte area.",
        ...
        "110+ in-house crew members with the equipment and capacity to handle large rural properties — we never use subcontractors.",
