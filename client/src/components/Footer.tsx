...
const LOGO_STACKED =
  "/manus-storage/logo-transparent-stacked_ff350b79_e45b3bfe.webp";
...
const landscapingLinks = [
  ...
  { label: "Decks & Pergolas", href: "/services/decks" },
...
const resourceArticleLinks = [
  ...
  { label: "Deck Cost in Bend, Oregon", href: "/resources/deck-cost-bend-oregon" },
